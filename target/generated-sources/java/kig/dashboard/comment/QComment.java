...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -96597135L;
    ...
    public final kig.dashboard.post.entity.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new kig.dashboard.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
