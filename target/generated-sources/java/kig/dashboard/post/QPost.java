...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = 917244879L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPost post = new QPost("post");

    public final kig.dashboard.global.config.QBaseTimeEntity _super = new kig.dashboard.global.config.QBaseTimeEntity(this);
    ...
    public QPost(Class<? extends Post> type, PathMetadata metadata, PathInits inits) {
        ...
        this.writer = inits.isInitialized("writer") ? new kig.dashboard.member.entity.QMember(forProperty("writer")) : null;
    }
